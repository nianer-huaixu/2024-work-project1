...
function AdaptiveHeight() {
  ...
  const data =[
    ...
    },
    {
      ...
      p1:'享营全国的现代综合性全铝服务企业，拥有“裁剪、切割、表面处理、成型和机加工”5大加工平台。常备铝台金材料[7075、7050、7A04(LC4)、 7A09 (LC9)、2A12 (LY12 )、2024、6061、 6063、 6082、 5A06 (LF6)、5A05 (LF5 )、5083、5754、 5052、 3A21 (LF21 )、3003、 1060、 1050、1070、2017、2A14( LY14 )、2A11 ( LY11 )、2124、2219、2017、 2A50 (LD5)、6A02 (LD2)、5A03 (LF3 )、5A02 (LF2)、6060、 MIC-6、 ]库存6000余吨，批发零售，量大现做(订货周期3-15天) !',
      p2:' ',
      p3:[]
    },
    {
      ...
      p1:'二十几年的风风雨雨，江苏扬东创造了骄人的业绩，令人瞩目也令人自豪。在新世纪的历史进程中，扬东始终坚持“团结、拼搏、务实、开拓”的精神，以“质量求生存，开拓求发展”的经营理念，我们倡导“以客户的目标为追求，以客户的需求为基础”站在客户的角度思考， 定尺交货，为客户降低成本。不断进取，不断完善，拥有21年专业销售经验与优秀团队，是遍布亚洲的知名供应商和国内最实力、规格最齐全的现货平台，从而使我们的产品更加精益求精，产品铺盖亚洲各地及国内大小型市场。',
      p2:' ',
      p3:[]
    },
    {
    ...
    },
    {
      ...
      p1:'“精工品质，真诚合作”，扬东集团谒诚为广大中外客户提供优质的高精铝材，为顾客提供满意的产品，是我司不懈追求，以求共同发展，共创佳绩。随着公司的壮大，集团继续弘扬”精诚求进” 的企业精神，恪守质量第一、用户至上的理念，不断地改进、完善自己。在发展道路上，寻求真诚合作，共同发展，扬东集团将与海内外各界同仁共创美好未来!',
      p2:' ',
      p3:[]
    },
    {
      ...
      p1:'我们致力于精工铝材产业链的打造,为客户提供更加丰富、更具价值的方案和综合服务;',
      p2:' ',
      p3:[]
    },
    {
