...
import pdfIcon from '../../../img/icon/pdf.svg'
import videoIcon from '../../../img/icon/video.svg'
import badgeIcon from '../../../img/icon/badge.svg'
import vsIcon from '../../../img/icon/VS_icon.svg'
...
function ProductDetail(props){
    ...
    function onmousemove(e){
			if(e.view.innerWidth>=1080){
				let x = e.pageX - small_div.offsetWidth - move_div.offsetWidth / 2;
    ...
    return (
			<div className={styles.productDetail1}>
				<div className={styles.productImgWrap}>
					...
					<div className={styles.productImgList}>
						<div className={[styles.productImgItemWrap,].join(' ')}>
			...
			<div className={styles.produceParamWrap}>
				...
				<p className={styles.productParamBtnGroup}>
						...
						<button className='whiteBtn' style={{marginLeft:'.125rem'}}><Link href='/contactus'>联系我们</Link></button>
				</p>
			</div>
		</div>
	)
			...
			<div className={styles.productMain}>
				...
				<div className={styles.productC}>
					<div className={styles.productBox}>
						...
						<h5 className={styles.anchor}>我们的优势 Our Advantages</h5>
						<div className={styles.usAdvantage}>
							<div className={styles.usAdvantageTitle}>
								<p>普通“铝材”</p>
								<Image src={vsIcon} alt='icon'/>
								<p>扬东“铝材”</p>
							</div>
							<div className={styles.usAdvantageContent}>
								<div className={styles.usAdvantageContentL}>
									{detail.substring(4,7) != '铝卷' && <p><span>&#10006;</span>加工过程中生产变形</p>}
									<p><span>&#10006;</span>表面灰暗无光泽</p>
									<p><span>&#10006;</span>阳极氧化后有黑线、花斑、明显色差等</p>
									{detail.substring(4,7) != '铝板' && <p><span>&#10006;</span>冲压加工铝板开裂和脱膜现象</p>}
									{detail.substring(4,7) != '铝卷' && <p><span>&#10006;</span>机加工粘刀，车铣加工精度差</p>}
									<p><span>&#10006;</span>加工后有砂眼、气孔、裂纹缺陷</p>
									<p><span>&#10006;</span>易氧化腐蚀，产生自斑等，长期使用有风险</p>
									<p><span>&#10006;</span>表面有划痕划伤等，运输造成二次伤害等</p>
									<p><span>&#10006;</span>无质保，无售后，无法溯源</p>
									<p><span>&#10006;</span>没有图纸无法接单</p>
								</div>
								<div className={styles.usAdvantageContentR}>
									{detail.substring(4,7) != '铝卷' && <p style={{lineHeight:'.375rem',paddingTop:'0'}}><span>&#10004;</span>我们采用先进的预拉伸工艺，消除内应力，加工过程不变形</p>}
									<p style={{lineHeight:'.375rem',paddingTop:'0'}}><span>&#10004;</span>表面抛光拉丝处理，亮面有光泽，可无需铣面直接使用</p>
									<p style={{lineHeight:'.375rem',paddingTop:'0'}}><span>&#10004;</span>材料均质化处理，阳极氧化后漂亮无色差</p>
									{detail.substring(4,7) != '铝板' && <p><span>&#10004;</span>回火工艺精湛，延展性好，使用中高粘性PE膜无气泡，冲压不易脱落</p>}
									{detail.substring(4,7) != '铝卷' && <p><span>&#10004;</span>采用先进淬火及时效处理，保证铝材性能的强度硬度，加工效率高，精度高，光洁度好</p>}
									<p><span>&#10004;</span>我们的原料全部采用先进超声波探伤检测，保证了产品无气孔无裂纹等缺陷</p>
									<p style={{lineHeight:'.375rem',paddingTop:'0'}}><span>&#10004;</span>我们铝材表面会形成一层抗氧化膜，可以长年抗腐蚀和抗氧化</p>
									<p><span>&#10004;</span>我们铝材出厂前都要通过专业人员三道质检，有合作十年以上的物流运输快捷，保证货物的品质和安全</p>
									<p><span>&#10004;</span>我们随货附带原厂质保书，又有专业进口光谱仪、硬度计等设备，可免费提供来样分析和检测</p>
									<p style={{lineHeight:'.375rem',paddingTop:'0'}}><span>&#10004;</span>来图来样我们可以免费图纸设计及拿样</p>
								</div>
							</div>
						</div>
						<ProductCom />  
