...
function MapComponent() {
        ...
        import('@amap/amap-jsapi-loader').then(AMapLoader => {
            ...
            version: '2.0',
                ...
                mapRef.current = new AMap.Map('container', {
                    ...
                    zoom: 19, // 初始化地图级别
                    center: [120.74330,31.352201], // 初始化地图中心点位置
                });
                const marker = new AMap.Marker({
                    position: new AMap.LngLat(120.74260, 31.352190),
                ...
                var text = new AMap.Text({
                    ...
                    position: [120.74260, 31.352190], //点标记在地图上显示的位置
                    });
    ...
    return (<div id="container" style={{width: "980px",height: "2.5625rem",}}/>);
}
